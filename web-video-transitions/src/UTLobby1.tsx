...
const UTLobby1 = () => {
  return (
    ...
    >
      ...
      <Link className="button" to="/dissolve2">
        디졸브
      </Link>
      ...
      <Link className="button" to="/window-slice2">
        윈도우 슬라이스
      </Link>
      ...
      <Link className="button" to="/wipe-down2">
        아래로 전환
      </Link>
      <Link className="button" to="/directional-warp2">
        대각선 물결
      </Link>
      <Link className="button" to="/mosaic2">
        모자이크
      </Link>
